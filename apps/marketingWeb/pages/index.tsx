  ...
  return (
    <Box>
      ...
      <Container maxW="1600px" px={10} position="relative">
        ...
        {/* Info #2 section */}
        <Box mt={{ base: 24, md: 200 }} position="relative">
          <Box
            position="absolute"
            zIndex={-1}
            width={1200}
                ...
                <Flex justify='space-between'>
                  <Flex direction='column' justify='space-between' align='start'>
                    <Box>
                      ...
                      <Heading maxWidth="800px" fontSize={{ base: '40px', md: '50px', lg: '60px' }}>Contribute to building the ultimate developer profile.</Heading>
                    </Box>
